    ...
    public void runTestsFromFile() {
        ...
        try {
            ...
            for (int i = 0; i < currentTests.length; i++) {
                ...
                long Leia = diaryInstance.getLeiaTerminate();
                ...
                if (soloTerminate - minTerminate > 0000000000020L || C3POTerminate - minTerminate > 0000000000020L
                        || LandoTermiante - minTerminate > 0000000000020L || R2D2Terminate - minTerminate > 0000000000020L|| Leia - minTerminate > 0000000000020L) {
                    passedThirdTest = false;
                    System.out.println("failed in time diff\nsolo -> " + soloTerminate + "\nc3po -> "+ C3POTerminate + "\nland -> "+ LandoTermiante + "\nr2d2 -> "+ R2D2Terminate + "\nleia -> "+ Leia + "\n");
                }
