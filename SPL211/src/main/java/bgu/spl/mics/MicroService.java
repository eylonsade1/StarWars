...
public abstract class MicroService implements Runnable { 
    ...
    private ConcurrentMap<Class,Callback> callBackMap;
    private boolean planetSaved;
    private String name;
    ...
    protected final void sendBroadcast(Broadcast b) {
        //System.out.println(name+"send broadcast");
    ...
    public final void run() {
        ...
        try {
            ...
            Callback c = callBackMap.get(message.getClass());
            c.call(message);
        }
